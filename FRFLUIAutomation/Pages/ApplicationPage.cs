...
namespace FRFLUIAutomation.Pages
{
    internal class ApplicationPage
    {
        ...
        private ILocator _mainApplicantPageNext => _page.Locator("#consumer-form > frf-wizard > div > div:nth-child(2) > div > div > div > div.row.btn-row > div > div > div > div.pull-right.col-xs-6 > button");
        ...
        private ILocator _employmentPageNext => _page.Locator("#consumer-form > frf-wizard > div > div:nth-child(2) > div > div > div > div.row.btn-row > div > div > div > div > button");
        ...
        private ILocator _additionalIncomePageNext => _page.Locator("#consumer-form > frf-wizard > div > div:nth-child(2) > div > div > div > div.row.btn-row > div > div > div > div.pull-right.col-xs-6 > button");
